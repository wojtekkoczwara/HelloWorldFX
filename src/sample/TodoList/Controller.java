...
//        Cell factory (initialize behaviour of cells)
    ...
    public void showNewItemDialog(){
        ...
        dialog.setHeaderText("Use this dialog to create a new odo item");
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("todoItemDialog.fxml"));
        try {
//            Parent root = FXMLLoader.load(getClass().getResource("addContactDialog.fxml"));
